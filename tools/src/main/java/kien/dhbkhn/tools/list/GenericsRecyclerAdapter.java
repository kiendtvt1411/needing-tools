 ...
 *
 * @param <T>  type of objects, which will be used in the
 *             adapter's dataset
 * @param <L>  click listener {@link BaseRecyclerListener}
 * @param <VH> ViewHolder {@link BaseViewHolder}
 */

public abstract class GenericsRecyclerAdapter<T, L extends BaseRecyclerListener,
     ...
     */
    public GenericsRecyclerAdapter(Context context) {
    ...
    /**
     * Called by RecyclerView to display the data at the
     * specified position. This method should update the contents of the
     ...
     *
     * @return The item has given position
     */
    ...
    public void addAll(List<T> items) {
        if (items == null) {
            throw new IllegalArgumentException("Cannot add `null` items to" +
    ...
    /**
     * Indicates whether each item in the data set can be
     * represented with a unique identifier of type {@link Long}
     *
     * @param hasStableIds Whether items in data set have unique
     *                     identifiers or not
     * @see #hasStableIds()
     * @see #getItemId(int)
     */
